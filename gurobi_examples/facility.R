...
# TRADUÇÂO
# Localização da instalação: uma empresa atualmente envia seu produto de 5
# fábricas para 4 armazéns. A empresa está avaliando fechar algumas fábricas
# para reduzir custos.
# Que planta (s) a empresa deve fechar, a fim de minimizar transporte e custos
# fixos?
...
nPlants     <- 5 # toral de fábricas
nWarehouses <- 4 # total de armazéns
